...
class TSRegressionArchive(BaseData):
    ...
    def load_single(self, filepath):
        ...
        if self.config['task'] == 'regression':
            ...
            #print(utils.load_from_tsfile_to_dataframe(filepath, return_separate_X_and_y=True, replace_missing_vals_with='NaN'))
            df, labels = load_from_tsfile_to_dataframe(filepath, return_separate_X_and_y=True, replace_missing_vals_with='NaN')
            ...
            try:
                data, _ = utils.load_from_tsfile_to_dataframe(filepath, return_separate_X_and_y=True,
